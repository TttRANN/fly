...
def process_video(input_video_path, output_dir,iteration):
    try:
        # Load the video
        ...
        for j in range(denominator):
            ...
            if frame_group:
                ...
                output_image_path = os.path.join(output_dir, f"iteration_{iteration}_merged_frame_{j}.png")
            ...
            print(f"Iteration {iteration+1} complete. {group_count} images saved to {output_dir}")
...
output_dir = '/Users/tairan/Downloads/output1'

# # Ensure the output directory exists
os.makedirs(output_dir, exist_ok=True)

process_video(input_video_path, output_dir,2)
