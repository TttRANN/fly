    ...
    try:
        ...
        while cap.isOpened():
            ...
            if valid_contours:
                ...
                # # cv2.circle(masked_frame, (cX, cY), 5, (0, 0, 255), -1)
            ...
            if valid_contours1:
                ...
                M1 = cv2.moments(biggest_contour1)
                if M1["m00"] != 0:
                ...
                # cv2.circle(masked_frame, (cX1, cY1), 5, (0, 0, 255), -1)
                centroids1.append((cX1, cY1))
            ...
            ax.plot(contour_areas, label="Contour Area")
...
input_folder = '/Users/tairan/Downloads/segment_540_780'
output_folder = '/Users/tairan/Downloads/segment_540_780/outputnew2'
...
for video_filename in os.listdir(input_folder):
    if video_filename.endswith('.mp4'):  # Adjust if there are other video formats
        ...
        # Save results to CSV
        with open('/Users/tairan/Downloads/rnai_gilt1-29C_t4t5_batch1/results.csv', 'a', newline='') as f:
            writer = csv.writer(f)
